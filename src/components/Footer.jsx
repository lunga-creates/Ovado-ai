    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          {/* Explore Ovado AI */}
          <div>
            <h3 className="text-[#fdb529] font-semibold mb-4">
              Explore Ovado AI
            </h3>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  ...
                  className=" hover:text-[#fdb529] text-sm flex items-center"
                >
                  <ChevronRight className="w-3 h-3 mr-1" /> Autonomous AI Voice
                  & Calling Agents
                </a>
              </li>
              <li>
            ...
            <ul className="space-y-2 mb-6">
              ...
              <li>
                <a
                  ...
                  className=" hover:text-[#fdb529] text-sm flex items-center"
                >
                  <ChevronRight className="w-3 h-3 mr-1" /> Manufacturing &
                  Operations
                </a>
              </li>
              <li>
          ...
          <div className="md:flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4 md:mt-0 mt-2">
              <p className="text-gray-400 text-sm">
                Copyright © Ovado AI | Designed by OVADO AI International
